...
import com.listron.demo.inventory.request.ProductInventoryCacheRefreshRequest;
import com.listron.demo.inventory.request.ProductInventoryDBUpdateRequest;
import com.listron.demo.inventory.request.Request;
import com.listron.demo.inventory.service.ProductInventoryService;
import com.listron.demo.inventory.service.RequestAsyncProcessService;
import com.listron.demo.inventory.vo.Response;
...
public class ProductInventoryController {
    ...
    public Response updateProductInventory(ProductInventory productInventory) {
        ...
        System.out.print("===========日志===========: 接收到更新商品库存的请求，商品id=" + productInventory.getProductId() + ", 商品库存数量=" + productInventory.getInventoryCnt());
    ...
    public ProductInventory getProductInventory(Integer productId) {
        System.out.print("===========日志===========: 接收到一个商品库存的读请求，商品id=" + productId);
        ...
        try {
            ...
            while(true) {
                ...
                if(productInventory != null) {
                    System.out.print("===========日志===========: 在200ms内读取到了redis中的库存缓存，商品id=" + productInventory.getProductId() + ", 商品库存数量=" + productInventory.getInventoryCnt());

package com.listron.demo.inventory.thread;
...
import com.listron.demo.inventory.request.RequestQueue;
            ...
            while(true) {
                ...
                if(!forceRfresh) {
                    ...
                    if(request instanceof ProductInventoryDBUpdateRequest) {
                        ...
                        System.out.print("===========日志===========ProductInventoryDBUpdateRequest");
                        flagMap.put(request.getProductId(), true);
                    } else if(request instanceof ProductInventoryCacheRefreshRequest) {
                        System.out.print("===========日志===========ProductInventoryCacheRefreshRequest");

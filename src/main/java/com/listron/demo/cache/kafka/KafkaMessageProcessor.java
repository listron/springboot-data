...
import static com.listron.demo.cache.spring.SpringContext.getBean;
...
public class KafkaMessageProcessor implements Runnable{
    ...
    private CacheService cacheService =SpringContext.
            getBean("cacheService",CacheService.class);

    public KafkaMessageProcessor(KafkaStream kafkaStream) {
        this.kafkaStream = kafkaStream;
        System.out.print("KafkaMessageProcessor" +"\n");
    }
    ...
    public void run() {
        ...
        while (it.hasNext()) {
            ...
            System.out.print("pring message:" + message + "\n");
            System.out.print("-----begin receive serviceId----- + \n");
            // 首先将message转换成json对象
            try{
                JSONObject messageJSONObject = JSONObject.parseObject(message);
                System.out.print("-----receive messageJSONObject----- + \n");
                // 从这里提取出消息对应的服务的标识
                String serviceId = messageJSONObject.getString("serviceId");
                System.out.print("----- serviceId:-----" + serviceId +"\n");
                System.out.print("-----end receive serviceId----- + \n");
                // 如果是商品信息服务
